...
/*Inheritance-
   ...
   class Template extends  MarvellousLogin{}  
 * 
 * Interface-
 * interface ActionListener{}
 * interface Runnable{}
 * class Template Implements ActionListener,Runnable{}
 * 
 */
...
public class Template extends JFrame implements Serializable,ActionListener
{
    ...
    public Template()
    {
        ...
        _top.setLayout(null);
         getContentPane().add(_top,new GridBagConstraints(0,0,1,1,1,5,GridBagConstraints.BASELINE,GridBagConstraints.BOTH,new java.awt.Insets(0,0,0,0),0,0));
    ...
    void Clock()
    {
        ...
        dateLable.setBackground(Color.blue);
